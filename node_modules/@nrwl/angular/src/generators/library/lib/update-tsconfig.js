...
function updateProjectConfig(host, options) {
    ...
    // tsconfig.json
    (0, devkit_1.updateJson)(host, `${options.projectRoot}/tsconfig.json`, (json) => (Object.assign(Object.assign({}, json), { compilerOptions: Object.assign(Object.assign({}, json.compilerOptions), { target: 'es2022', useDefineForClassFields: false }) })));
}
